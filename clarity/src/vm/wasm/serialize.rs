...
use crate::vm::types::serialization::TypePrefix;
use crate::vm::types::{
    ListTypeData, SequenceSubtype, StringSubtype, TupleTypeSignature, TypeSignature,
};
use crate::vm::wasm::wasm_generator::{clar2wasm_ty, GeneratorError, WasmGenerator};
use crate::vm::wasm::wasm_utils::{get_type_size, PRINCIPAL_BYTES, STANDARD_PRINCIPAL_BYTES};
...
mod tests {
    ...
    use crate::vm::wasm::wasm_generator::WasmGenerator;
    use crate::vm::Value;
    ...
    fn serialization_size_string_ascii() {
        ...
        let ty = TypeSignature::SequenceType(SequenceSubtype::StringType(
            crate::vm::types::StringSubtype::ASCII(96u32.try_into().unwrap()),
        ));
    ...
    fn serialization_size_string_utf8() {
        ...
        .unwrap();
        let ty = TypeSignature::SequenceType(SequenceSubtype::StringType(
            crate::vm::types::StringSubtype::UTF8(100usize.try_into().unwrap()),
        ));

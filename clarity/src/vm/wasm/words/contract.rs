...
use crate::vm::wasm::wasm_utils::get_type_size;
use crate::vm::wasm::wasm_utils::{check_argument_count, ArgumentCountCheck};
use crate::vm::{ClarityName, SymbolicExpression, SymbolicExpressionType, Value};
...
(define-read-only (get-val)
    ...
    "#;
        ...
        crosscheck_multi_contract_with_env(
            ...
            Ok(Some(Value::okay_true())),
            TestEnvironment::new(StacksEpochId::Epoch20, ClarityVersion::Clarity1),
        );
    }
}

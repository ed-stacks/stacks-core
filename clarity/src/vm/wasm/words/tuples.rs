...
use crate::vm::wasm::wasm_generator::{clar2wasm_ty, drop_value, GeneratorError, WasmGenerator};
...
mod tests {
    ...
    use clarity_types::types::{ASCIIData, BuffData, CharType, SequenceData};
    ...
    fn merge_multiple_same_key_different_type() {
        ...
        let expected = Value::from(
            TupleData::from_data(vec![
                ...
                (ClarityName::from("b"), Value::UInt(789)),
                (
                    ClarityName::from("c"),
                ...
                (ClarityName::from("d"), Value::Int(123)),
            ])
            .unwrap(),
        );

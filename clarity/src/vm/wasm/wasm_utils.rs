...
use crate::vm::wasm::error_mapping::{self, ErrorMap};
use crate::vm::wasm::initialize::ClarityWasmContext;
use crate::vm::wasm::linker::link_host_functions;
use crate::vm::wasm::wasm_generator::{GeneratorError, WasmGenerator};
use crate::vm::wasm::CostLinker;
use crate::vm::{CallStack, ClarityName, ClarityVersion, ContractContext, ContractName, Value};
        ...
        TypeSignature::TupleType(t) => {
            ...
            for (name, ty) in t.get_type_map() {
                ...
                data_map.push((
                    name.clone(),
                    value.ok_or_else(|| {
                        Error::Unchecked(CheckErrorKind::NoSuchTupleField(
                            format!(
...
mod tests {
    ...
    use crate::vm::types::{StandardPrincipalData, TraitIdentifier};
    use crate::vm::wasm::wasm_utils::{trait_identifier_as_bytes, trait_identifier_from_bytes};
